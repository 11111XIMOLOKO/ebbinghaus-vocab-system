...
public class WordBookController {
    ...
    public WordBookController(WordBookService wordBookService) { this.wordBookService = wordBookService; }

    @GetMapping
    @Operation(summary = "获取全部词库列表")
    public Result<List<WordBook>> list() { return Result.ok(wordBookService.listAll()); }
}
