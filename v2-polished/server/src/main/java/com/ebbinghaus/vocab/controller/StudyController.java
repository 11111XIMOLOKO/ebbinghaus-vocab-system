...
public class StudyController {
    ...
    @PostMapping("/submit")
    @Operation(summary = "提交学习/复习结果")
    public Result<Void> submit(@Valid @RequestBody SubmitRequest req, HttpServletRequest request) {
        Long userId = (Long) request.getAttribute(JwtInterceptor.USER_ID_ATTR);
